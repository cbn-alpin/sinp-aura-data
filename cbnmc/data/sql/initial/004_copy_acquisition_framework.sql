...
\echo '-------------------------------------------------------------------------------'
\echo 'Generate UUID for acquisition frameworks if necessary'
UPDATE tmp_acquisition_frameworks SET
    unique_acquisition_framework_id = public.uuid_generate_v4()
WHERE unique_acquisition_framework_id IS NULL ;
