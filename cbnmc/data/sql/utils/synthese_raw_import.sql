...
CREATE TABLE raw_cbnmc_synthese (
    ...
    code_area_attachment varchar(25) NULL,
    ...
    CONSTRAINT pk_raw_cbnmc_synthese PRIMARY KEY (gid)
);
...
-- To transform a field from text to JSONB
-- ALTER TABLE raw_cbnmc_synthese
-- ALTER COLUMN additional_data TYPE jsonb
-- USING (CASE WHEN additional_data = '\N' THEN NULL ELSE additional_data::jsonb END);
