...
CREATE TEMPORARY TABLE delete_acquisition_framewords (
    unique_acquisition_framework uuid,
    primary key (unique_acquisition_framework)
) ;
INSERT INTO delete_acquisition_framewords (unique_acquisition_framework)
...
USING gn_synthese.synthese AS s,
    ...
    delete_acquisition_framewords AS df
...
USING gn_meta.t_acquisition_frameworks af, delete_acquisition_framewords AS df
WHERE  td.id_acquisition_framework = af.id_acquisition_framework
    AND af.unique_acquisition_framework_id = df.unique_acquisition_framework ;

DELETE FROM gn_meta.cor_acquisition_framework_actor AS ac
USING  gn_meta.t_acquisition_frameworks AS af, delete_acquisition_framewords AS df
...
USING delete_acquisition_framewords AS df
