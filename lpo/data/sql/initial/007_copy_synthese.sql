...
COPY synthese (
    ...
    id_source,
    id_dataset, -- Field value set by parser !
    id_module, -- Field added by parser !
    id_nomenclature_geo_object_nature,
    id_nomenclature_grp_typ,
    -- grp_method, -- Missing field !
    id_nomenclature_obs_technique, -- Field value set by parser !
    ...
    cd_hab,
    nom_cite,
    meta_v_taxref, -- Field added by parser
    ...
    observers,
    determiner,
    id_digitiser, -- Field added by parser !
