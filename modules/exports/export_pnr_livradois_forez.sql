...
\echo '----------------------------------------------------------------------------'
\echo 'Create materialized view gn_exports.pnr_livradois_forez'

CREATE MATERIALIZED VIEW gn_exports.pnr_livradois_forez AS
WITH
...
CREATE UNIQUE INDEX unique_idx_pnr_livradois_forez
ON gn_exports.pnr_livradois_forez (id_synthese) ;
