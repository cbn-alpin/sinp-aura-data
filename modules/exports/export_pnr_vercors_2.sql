-- PNR Vercors synthese export with precise geom >= 2017 (2)
...
\echo '----------------------------------------------------------------------------'
\echo 'Drop materialized view if exists gn_exports.pnr_vercors_2'
DROP MATERIALIZED VIEW IF EXISTS gn_exports.pnr_vercors_2;

\echo '----------------------------------------------------------------------------'
\echo 'Create materialized view gn_exports.pnr_vercors_2'

CREATE MATERIALIZED VIEW gn_exports.pnr_vercors_2 AS
WITH
pnr_vercors AS (
    SELECT
        UNNEST(
            ARRAY['26001','26023','26024','26034','26035','26039','26059','26066','26069','26074',
                '26081','26086','26098','26100','26108','26113','26117','26141','26142','26149',
                '26159','26163','26168','26175','26217','26221','26223','26224','26232','26240',
                '26246','26270','26273','26281','26282','26289','26290','26291','26299','26302',
                '26307','26308','26309','26311','26315','26316','26320','26327','26331','26346',
                '26359','26364','26382','38018','38036','38090','38092','38103','38108','38111',
                '38113','38117','38129','38153','38169','38185','38186','38187','38195','38205',
                '38216','38225','38226','38235','38243','38248','38281','38301','38319','38322',
                '38333','38338','38345','38355','38356','38390','38391','38409','38416','38419',
                '38429','38433','38436','38438','38443','38450','38453','38474','38485','38486',
                '38524','38540','38548','38559','26187','38021','26354']
        ) AS code
),
synthese_export AS (
    SELECT DISTINCT
...
CREATE UNIQUE INDEX unique_idx_pnr_vercors_2
ON gn_exports.pnr_vercors_2 (id_synthese) ;
