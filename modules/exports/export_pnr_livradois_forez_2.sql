...
synthese_export AS (
    ...
    FROM gn_synthese.synthese AS s
        ...
        JOIN pnr_livradois_forez_2 AS p
...
CREATE UNIQUE INDEX unique_idx_pnr_livradois_forez_2
ON gn_exports.pnr_livradois_forez_2 (id_synthese) ;
