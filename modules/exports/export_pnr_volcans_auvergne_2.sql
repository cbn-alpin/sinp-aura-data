-- PNR des volcans d'Auvergne synthese export with precise geom >= 2015 & < 2020 (2)
...
\echo '----------------------------------------------------------------------------'
\echo 'Drop materialized view if exists gn_exports.pnr_volcans_auvergne_2'
DROP MATERIALIZED VIEW IF EXISTS gn_exports.pnr_volcans_auvergne_2;

\echo '----------------------------------------------------------------------------'
\echo 'Create materialized view gn_exports.pnr_volcans_auvergne_2'

CREATE MATERIALIZED VIEW gn_exports.pnr_volcans_auvergne_2 AS
WITH
...
CREATE UNIQUE INDEX unique_idx_pnr_volcans_auvergne_2
ON gn_exports.pnr_volcans_auvergne_2 (id_synthese) ;
