-- PNR Vercors synthese export with geom blurred depending on sensitivity level < 2017 (1)
...
\echo '----------------------------------------------------------------------------'
\echo 'Create materialized view gn_exports.pnr_vercors_blurred_1'

CREATE MATERIALIZED VIEW gn_exports.pnr_vercors_blurred_1 AS
WITH
blurred_centroid AS (
	SELECT
		sb.id_synthese,
