...
\echo '----------------------------------------------------------------------------'
\echo 'Drop materialized view if exists gn_exports.pnr_volcans_auvergne_3'
DROP MATERIALIZED VIEW IF EXISTS gn_exports.pnr_volcans_auvergne_3;

\echo '----------------------------------------------------------------------------'
\echo 'Create materialized view gn_exports.pnr_volcans_auvergne_3'

CREATE MATERIALIZED VIEW gn_exports.pnr_volcans_auvergne_3 AS
WITH
...
CREATE UNIQUE INDEX unique_idx_pnr_volcans_auvergne_3
ON gn_exports.pnr_volcans_auvergne_3 (id_synthese) ;
