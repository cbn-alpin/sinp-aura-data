-- PNR des volcans d'Auvergne synthese export with geom blurred depending on sensitivity level >= 2020 (3)
...
\echo '----------------------------------------------------------------------------'
\echo 'Create materialized view gn_exports.pnr_volcans_auvergne_blurred_3'

CREATE MATERIALIZED VIEW gn_exports.pnr_volcans_auvergne_blurred_3 AS
WITH
blurred_centroid AS (
    SELECT
        sb.id_synthese,
...
CREATE UNIQUE INDEX unique_idx_pnr_volcans_auvergne_blurred_3
