/*
 ...
 Before to start, please adapt the name of the schema 'gn2pg_lpo' to the one you set in your config file.
...
CREATE SCHEMA IF NOT EXISTS gn2pg_lpo;

DROP FUNCTION IF EXISTS
    gn2pg_lpo.fct_c_get_or_insert_basic_af_from_uuid_name (_uuid uuid ,
    _name TEXT);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_check_has_additional_data_column
...
BEGIN
    ...
    IF gn2pg_lpo.fct_c_check_has_additional_data_column ('gn_meta' ,
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_or_insert_basic_af_from_uuid_name
    (_uuid uuid , _name TEXT) IS 'function to basically create acquisition framework';


/* Datasets */
DROP FUNCTION IF EXISTS
    gn2pg_lpo.fct_c_get_or_insert_basic_dataset_from_uuid_name (_uuid uuid ,
...
BEGIN
    ...
    IF gn2pg_lpo.fct_c_check_has_additional_data_column ('gn_synthese' ,
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_or_insert_source (_source TEXT) IS
    'function to basically create new sources';


/* Areas attachments */
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_get_id_area (_type_code CHARACTER
    VARYING , _area_code CHARACTER VARYING);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_get_id_area (_type_code CHARACTER
    VARYING , _area_code CHARACTER VARYING)
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_id_area (VARCHAR , VARCHAR) IS 'Custom function to get id_area from area type code and area code';


/*  Nomenclatures */
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_get_id_nomenclature (_type TEXT ,
    _cd_nomenclature TEXT);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_get_id_nomenclature (_type
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_id_nomenclature (VARCHAR , VARCHAR)
    IS 'Custom function to get nomenclature with default value id possible';

DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_get_id_nomenclature_from_label
    (_type TEXT , _label TEXT);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_get_id_nomenclature_from_label
    (_type TEXT , _label TEXT)
    RETURNS INTEGER
    AS $func$
DECLARE
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_id_nomenclature_from_label (_type
 ...
 */
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_territories (_id_af
    INTEGER , _territories jsonb);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_territories (_id_af
    INTEGER , _territories JSONB)
    RETURNS BOOLEAN
    LANGUAGE plpgsql
    AS $$
...
BEGIN
    ...
    FOR i IN (
		...
		(id_acquisition_framework , id_nomenclature_territory)
                VALUES (_id_af , gn2pg_lpo.fct_c_get_id_nomenclature ('TERRITOIRE' , i.item))
            ON CONFLICT
                DO NOTHING;
        END LOOP;
    RETURN TRUE;
...
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_objectives (_id_af INTEGER
    , _objectives jsonb);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_objectives (_id_af
...
BEGIN
    ...
    FOR i IN (
		...
		(id_acquisition_framework , id_nomenclature_objectif)
                VALUES (_id_af , gn2pg_lpo.fct_c_get_id_nomenclature ('CA_OBJECTIFS' , i.item))
            ON CONFLICT
                DO NOTHING;
        END LOOP;
    RETURN TRUE;
...
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_sinp_theme (_id_af INTEGER
    , _sinp_themes jsonb);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_sinp_theme (_id_af
...
BEGIN
    ...
    FOR i IN (
		...
		(id_acquisition_framework , id_nomenclature_voletsinp)
                VALUES (_id_af , gn2pg_lpo.fct_c_get_id_nomenclature ('VOLET_SINP' , i.item))
            ON CONFLICT
                DO NOTHING;
        END LOOP;
    RETURN TRUE;
...
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_publications (_id_af
    INTEGER , _objectives jsonb);


/*
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_publications (_id_af
...
$$;
 */
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_ds_territories (_id_ds
    INTEGER , _territories jsonb);

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_ds_territories (_id_ds
    INTEGER , _territories JSONB)
    RETURNS VOID
    LANGUAGE plpgsql
    AS $$
...
BEGIN
    ...
    FOR i IN (
		...
		VALUES (_id_ds , gn2pg_lpo.fct_c_get_id_nomenclature
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_get_or_create_actors_in_usershub
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_dataset_actor (_id_dataset
...
BEGIN
    FOR i IN (
		...
		INSERT INTO gn_meta.cor_dataset_actor (id_dataset , id_organism
		    ...
		    VALUES (_id_dataset ,
			gn2pg_lpo.fct_c_get_or_create_actors_in_usershub
			(i.item , _source) ,
			gn2pg_lpo.fct_c_get_id_nomenclature ('ROLE_ACTEUR' ,
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_actors (_id_af INTEGER
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_get_or_insert_af_from_af_jsondata
...
BEGIN
	...
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('TYPE_FINANCEMENT' ,
	    _af_data #>> '{financing_type}'))::INT
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('NIVEAU_TERRITORIAL' ,
    ...
    PERFORM
        gn2pg_lpo.fct_c_insert_af_actors (the_af_id , _af_data -> 'actors' , _source);
    ...
    END IF;
    PERFORM
        gn2pg_lpo.fct_c_insert_af_territories (the_af_id , the_territories);
    ...
    END IF;
    PERFORM
        gn2pg_lpo.fct_c_insert_af_objectives (the_af_id , the_objectives);
    ...
    END IF;
    PERFORM
        gn2pg_lpo.fct_c_insert_af_sinp_theme (the_af_id , the_voletsinp);
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_or_insert_af_from_af_jsondata (jsonb
    , VARCHAR) IS 'function to create acquisition framework from json structured data';

CREATE OR REPLACE FUNCTION
    gn2pg_lpo.fct_c_get_or_insert_dataset_from_jsondata (_ds_data JSONB ,
...
BEGIN
	...
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('STATUT_SOURCE' , _ds_data
	    #>> '{source_status}'))::INT
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('RESOURCE_TYP' , _ds_data
	    #>> '{resource_type}'))::INT
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('JDD_OBJECTIFS' , _ds_data
	    #>> '{dataset_objectif}'))::INT
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('DS_PUBLIQUE' , _ds_data #>>
	    '{data_origin}'))::INT
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('METHO_RECUEIL' , _ds_data
	    #>> '{collecting_method}'))::INT
	, (gn2pg_lpo.fct_c_get_id_nomenclature ('DATA_TYP' , _ds_data #>>
	    '{data_type}'))::INT
    ...
    PERFORM
	gn2pg_lpo.fct_c_insert_dataset_actor (the_dataset_id , _ds_data ->
	    'actors' , _source);
    IF jsonb_array_length(_ds_data -> 'territories') > 0 THEN
        PERFORM
            gn2pg_lpo.fct_c_insert_ds_territories (the_dataset_id , _ds_data -> 'territories');
    END IF;
    IF gn2pg_lpo.fct_c_check_has_additional_data_column ('gn_meta' ,
	't_datasets' , 'additional_data') THEN
        UPDATE
...
COMMENT ON FUNCTION gn2pg_lpo.fct_c_get_or_insert_dataset_from_jsondata
    (jsonb , INTEGER , VARCHAR) IS 'function to basically create datasets';

CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_get_af_id_from_uuid (_uuid UUID)
    RETURNS INTEGER
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_get_dataset_id_from_uuid (_uuid UUID)
    RETURNS INTEGER
    AS $fct_get_af_id_from_uuid$
DECLARE
    the_id INT;
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_tri_upsert_metadata_to_geonature ()
    RETURNS TRIGGER
    LANGUAGE plpgsql
...
BEGIN
    IF NEW.level = 'acquisition framework' THEN
        PERFORM
            gn2pg_lpo.fct_c_get_or_insert_af_from_af_jsondata (NEW.item , NEW.source);
    ELSIF NEW.level = 'dataset' THEN
        PERFORM
	    gn2pg_lpo.fct_c_get_or_insert_dataset_from_jsondata (NEW.item ,
		gn2pg_lpo.fct_get_af_id_from_uuid (cast(NEW.item #>>
...
COMMENT ON FUNCTION gn2pg_lpo.fct_tri_upsert_metadata_to_geonature () IS 'Function to upsert metadata from gn2pg_lpo.metadata_json';

DROP TRIGGER IF EXISTS tri_c_upsert_metadata_to_geonature ON gn2pg_lpo.metadata_json;

CREATE TRIGGER tri_c_upsert_metadata_to_geonature
    AFTER INSERT ON gn2pg_lpo.metadata_json
    FOR EACH ROW
    EXECUTE PROCEDURE gn2pg_lpo.fct_tri_upsert_metadata_to_geonature ();

-- UPSERT
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_tri_c_upsert_data_to_geonature ()
    RETURNS TRIGGER
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    SELECT
        gn2pg_lpo.fct_c_get_or_insert_source (NEW.source) INTO the_id_source;
    ...
    SELECT
        ...
        WHEN 'synthese_with_metadata' THEN
            gn2pg_lpo.fct_get_af_id_from_uuid (cast(NEW.item #>> '{ca_uuid}' AS UUID))
        ELSE
	    gn2pg_lpo.fct_c_get_or_insert_basic_af_from_uuid_name
    ...
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_metadata' THEN
            gn2pg_lpo.fct_get_dataset_id_from_uuid (cast(NEW.item #>> '{jdd_uuid}' AS UUID))
        ELSE
	    gn2pg_lpo.fct_c_get_or_insert_basic_dataset_from_uuid_name
    ...
    SELECT
	    ...
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('NAT_OBJ_GEO' ,
		NEW.item #>> '{nature_objet_geo}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('NAT_OBJ_GEO' , NEW.item
		#>> '{nature_objet_geo}')
        END AS id_nomenclature_geo_object_nature INTO the_id_nomenclature_geo_object_nature;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('TYP_GRP' ,
		NEW.item #>> '{type_regroupement}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('TYP_GRP' , NEW.item #>> '{type_regroupement}')
    ...
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('METH_OBS' ,
		NEW.item #>> '{technique_obs}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('METH_OBS' , NEW.item #>> '{technique_obs}')
        END AS id_nomenclature_obs_technique INTO the_id_nomenclature_obs_technique;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('STATUT_BIO' ,
		NEW.item #>> '{statut_biologique}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('STATUT_BIO' , NEW.item #>>
		'{statut_biologique}')
        END AS id_nomenclature_bio_status INTO the_id_nomenclature_bio_status;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('ETA_BIO' ,
		NEW.item #>> '{etat_biologique}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('ETA_BIO' , NEW.item #>> '{etat_biologique}')
        END AS id_nomenclature_bio_condition INTO the_id_nomenclature_bio_condition;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('NATURALITE' ,
		NEW.item #>> '{naturalite}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('NATURALITE' , NEW.item #>> '{naturalite}')
        END AS id_nomenclature_naturalness INTO the_id_nomenclature_naturalness;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('PREUVE_EXIST' ,
		NEW.item #>> '{preuve_existante}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('PREUVE_EXIST' , NEW.item
		#>> '{preuve_existante}')
        END AS id_nomenclature_exist_proof INTO the_id_nomenclature_exist_proof;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('STATUT_VALID' ,
		NEW.item #>> '{statut_validation}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('STATUT_VALID' , NEW.item
		#>> '{statut_validation}')
        END AS id_nomenclature_valid_status INTO the_id_nomenclature_valid_status;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('NIV_PRECIS' ,
		NEW.item #>> '{precision_diffusion}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('NIV_PRECIS' , NEW.item #>>
		'{precision_diffusion}')
        END AS id_nomenclature_diffusion_level INTO the_id_nomenclature_diffusion_level;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('STADE_VIE' ,
		NEW.item #>> '{stade_vie}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('STADE_VIE' , NEW.item #>> '{stade_vie}')
        END AS id_nomenclature_life_stage INTO the_id_nomenclature_life_stage;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
            gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('SEXE' , NEW.item #>> '{sexe}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('SEXE' , NEW.item #>> '{sexe}')
        END AS id_nomenclature_sex INTO the_id_nomenclature_sex;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('OBJ_DENBR' ,
		NEW.item #>> '{objet_denombrement}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('OBJ_DENBR' , NEW.item #>>
		'{objet_denombrement}')
        END AS id_nomenclature_obj_count INTO the_id_nomenclature_obj_count;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('TYP_DENBR' ,
		NEW.item #>> '{type_denombrement}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('TYP_DENBR' , NEW.item #>>
		'{type_denombrement}')
        END AS id_nomenclature_type_count INTO the_id_nomenclature_type_count;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('SENSIBILITE' ,
		NEW.item #>> '{niveau_sensibilite}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('SENSIBILITE' , NEW.item
		#>> '{niveau_sensibilite}')
        END AS id_nomenclature_sensitivity INTO the_id_nomenclature_sensitivity;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('STATUT_OBS' ,
		NEW.item #>> '{statut_observation}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('STATUT_OBS' , NEW.item #>>
		'{statut_observation}')
        END AS id_nomenclature_observation_status INTO the_id_nomenclature_observation_status;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('DEE_FLOU' ,
		NEW.item #>> '{floutage_dee}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('DEE_FLOU' , NEW.item #>> '{floutage_dee}')
        END AS id_nomenclature_blurring INTO the_id_nomenclature_blurring;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('STATUT_SOURCE'
		, NEW.item #>> '{statut_source}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('STATUT_SOURCE' , NEW.item
		#>> '{statut_source}')
    ...
    SELECT
	    ...
	    gn2pg_lpo.fct_c_get_id_area (NEW.item #>>
    ...
    SELECT
        CASE WHEN the_id_area_attachment IS NOT NULL THEN
            gn2pg_lpo.fct_c_get_id_nomenclature ('TYP_INF_GEO' , '2')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('TYP_INF_GEO' , '1')
        END INTO the_id_nomenclature_info_geo_type;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label
		('OCC_COMPORTEMENT' , NEW.item #>> '{comportement}')
        ELSE
	    gn2pg_lpo.fct_c_get_id_nomenclature ('OCC_COMPORTEMENT' ,
		NEW.item #>> '{comportement}')
        END AS id_nomenclature_behaviour INTO the_id_nomenclature_behaviour;
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
	    gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('STAT_BIOGEO' ,
		NEW.item #>> '{statut_biogeo}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('STAT_BIOGEO' , NEW.item #>> '{statut_biogeo}')
    ...
    SELECT
        CASE NEW.type
        WHEN 'synthese_with_label' THEN
            gn2pg_lpo.fct_c_get_id_nomenclature_from_label ('TYPE' , NEW.item #>> '{methode_determination}')
        ELSE
            gn2pg_lpo.fct_c_get_id_nomenclature ('TYPE' , NEW.item #>> '{methode_determination}')
...
COMMENT ON FUNCTION gn2pg_lpo.fct_tri_c_upsert_data_to_geonature () IS 'Trigger function to upsert datas from import to synthese';
...
CREATE TRIGGER tri_c_upsert_data_to_geonature
    AFTER INSERT OR UPDATE ON gn2pg_lpo.data_json
    FOR EACH ROW
...
BEGIN
	...
	gn2pg_lpo.fct_c_get_or_insert_source (OLD.source)) =
...
COMMENT ON FUNCTION gn2pg_lpo.fct_tri_c_delete_data_from_geonature () IS 'Trigger function to delete datas';
...
CREATE TRIGGER tri_c_delete_data_from_geonature
    AFTER DELETE ON gn2pg_lpo.data_json
    FOR EACH ROW
