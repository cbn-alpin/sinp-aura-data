...
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_territories (_id_af INTEGER, _territories jsonb) ;
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_objectives (_id_af INTEGER, _objectives jsonb) ;
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_sinp_theme (_id_af INTEGER, _sinp_themes jsonb) ;
DROP FUNCTION IF EXISTS gn2pg_lpo.fct_c_insert_af_publications (_id_af INTEGER, _objectives jsonb) ;
...
$func$
    ...
    BEGIN
        ...
        THEN
            ...
            IF gn2pg_lpo.fct_c_check_has_additional_data_column(
                'gn_meta',
...
COMMENT ON FUNCTION
    gn2pg_lpo.fct_c_get_or_insert_basic_af_from_uuid_name (_uuid UUID, _name TEXT)
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_territories(
        _id_af INTEGER,
        _territories jsonb
    )
    RETURNS BOOLEAN
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_objectives(
        _id_af INTEGER,
        _objectives jsonb
    )
    RETURNS BOOLEAN
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_sinp_theme(
        _id_af INTEGER,
        _sinp_themes jsonb
    )
    RETURNS BOOLEAN
...
-- CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_publications(
--         _id_af INTEGER,
--         _publications jsonb
--     )
--     RETURNS VOID
...
CREATE OR REPLACE
    FUNCTION gn2pg_lpo.fct_c_insert_dataset_actor(
        _id_dataset INTEGER,
        _actor_roles JSONB,
        _source CHARACTER VARYING
    )
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_insert_af_actors(
        _id_af INTEGER,
        _actor_roles JSONB,
        _source CHARACTER VARYING
    )
...
$func$
    ...
    BEGIN
        ...
        THEN
            ...
            PERFORM gn2pg_lpo.fct_c_insert_af_actors(the_af_id, _af_data -> 'actors', _source) ;
            ...
            PERFORM gn2pg_lpo.fct_c_insert_af_territories(the_af_id, the_territories) ;
            ...
            PERFORM gn2pg_lpo.fct_c_insert_af_objectives(the_af_id, the_objectives) ;
            ...
            PERFORM gn2pg_lpo.fct_c_insert_af_sinp_theme(the_af_id, the_voletsinp) ;
...
CREATE OR REPLACE FUNCTION gn2pg_lpo.fct_c_get_or_insert_dataset_from_jsondata(
        _ds_data JSONB,
        _id_af INTEGER,
        _source CHARACTER VARYING
    )
...
$func$
    ...
    BEGIN
        ...
        THEN
            ...
            PERFORM gn2pg_lpo.fct_c_insert_dataset_actor(
                the_dataset_id, _ds_data -> 'actors',
                _source
            ) ;

            IF jsonb_array_length(_ds_data -> 'territories') > 0 THEN
                PERFORM gn2pg_lpo.fct_c_insert_ds_territories(
                    the_dataset_id,
...
$func$
    ...
    BEGIN
        ...
        SELECT
            CASE new.type
                WHEN 'synthese_with_metadata' THEN
                    gn2pg_lpo.fct_c_get_or_insert_af_from_af_jsondata(
                        new.item #> '{ca_data}',
                        new.source
                    )
        ...
        SELECT
            CASE new.type
                WHEN 'synthese_with_metadata' THEN
                    gn2pg_lpo.fct_c_get_or_insert_dataset_from_jsondata(
                        new.item #> '{jdd_data}',
                        the_id_af,
                        new.source
                    )
